...
**report** ის სისტემა ამჟამად არის extent report-ზე. სამომავლოდ ახალი რეპორტინგი მარტივად ჩაემატება, ვინაიდან დაემატა აბსტრაქცია და ინტერფეისი რომელიც რეპორტინგს აიმპლემენტირებს
შესაბამისად მხოლოდ 1 კლასის შეცვლა იქნება საჭირო რომ ახალი რეპორტნგის სისტემა დავამატო. (არა 13 კლაასის)
